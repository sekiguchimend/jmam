-- Update find_similar_responses_for_scoring function to include all score fields
-- This function returns similar responses with all score details
...
BEGIN
  ...
  USING embedding_array, p_question, p_case_id, p_limit;
END;
$$;
